...
This movie recommendation system is written using the python API of Apache Spark. It recommends the user with new movie he/she might be interested in, based on the movies they have previously rated. 

##Approach

* This is a “collaborative filtering” problem. There is an implementation of a collaborative filtering algorithm built into pyspark.mllib.
* To register the user-entered titles with Tweetings, I used the Tweetings title with the smallest Levenshtein distance from the user's entry. There is a Levenshtein implementation in pyspark.sql, or others for Python.
